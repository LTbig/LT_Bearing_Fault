...
def ready_data():
    ...
    PU_N15_M07_F10_data = load_N15_M07_F10_data()
    print("PU_N15_M07_F10_data_length:", len(PU_N15_M07_F10_data))
    PU_data_n = PU_N15_M07_F10_data[0]
    PU_data_in = PU_N15_M07_F10_data[2]
    PU_data_out = PU_N15_M07_F10_data[1]
