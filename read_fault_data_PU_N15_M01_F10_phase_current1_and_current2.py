...
def ready_data():
    ...
    print("PU_N15_M01_F10_data_length:", len(PU_N15_M01_F10_data_1))
    ...
    print("PU_N15_M01_F10_data_length:", len(PU_N15_M01_F10_data_2))
    PU_data_n_2 = PU_N15_M01_F10_data_2[0]
    PU_data_in_2 = PU_N15_M01_F10_data_2[2]
    PU_data_out_2 = PU_N15_M01_F10_data_2[1]

    PU_data_n_1, PU_data_n_2 = filter(PU_data_n_2, PU_data_n_1)
    PU_data_in_1, PU_data_in_2 = filter(PU_data_in_2, PU_data_in_1)
    PU_data_out_1, PU_data_out_2 = filter(PU_data_out_2, PU_data_out_1)
    '''
    2.处理轴承数据
    '''
    # 切割数据
    ...
    # 0
    j = []
    for a, b in zip(PU_data_n_1_cut, PU_data_n_2_cut):
        j = [a, b]
        PU_data_n_cut_packge.append(j)
        j = []
    # 1
    j = []
    for a, b in zip(PU_data_in_1_cut, PU_data_in_2_cut):
        j = [a, b]
        PU_data_in_cut_packge.append(j)
        j = []
    # 2
    j = []
    for a, b in zip(PU_data_out_1_cut, PU_data_out_2_cut):
        j = [a, b]
    ...
    PU_data_n_1_label = [[2] for index in range(len(PU_data_n_1_cut))]
    ...
    PU_data_n_2_label = [[2] for index in range(len(PU_data_n_2_cut))]
    ...
    Fault_label = []
    Fault_label = Fault_label + PU_data_out_1_label + PU_data_in_1_label + PU_data_n_1_label + \
                    PU_data_out_2_label + PU_data_in_2_label + PU_data_n_2_label
    Fault = []
