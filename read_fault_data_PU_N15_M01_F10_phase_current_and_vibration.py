...
from read_data_PU_subject import load_N15_M01_F10_data_phase_current_1
from read_data_PU_subject import load_N15_M01_F10_data_phase_current_2
from read_data_PU_subject import load_N15_M01_F10_data
import numpy as np
...
def filter(signal_1, signal_2, signal_3):
    ...
    return Min_Max_Scaling_2(current_multiplication), Min_Max_Scaling_2(vibration)
...
def ready_data():
    ...
    PU_N15_M01_F10_data_1 = load_N15_M01_F10_data_phase_current_1()
    print("PU_N15_M01_F10_data_1_length:", len(PU_N15_M01_F10_data_1))
    PU_data_n_1 = PU_N15_M01_F10_data_1[0]
    PU_data_in_1 = PU_N15_M01_F10_data_1[2]
    PU_data_out_1 = PU_N15_M01_F10_data_1[1]

    PU_N15_M01_F10_data_2 = load_N15_M01_F10_data_phase_current_2()
    print("PU_N15_M01_F10_data_2_length:", len(PU_N15_M01_F10_data_2))
    PU_data_n_2 = PU_N15_M01_F10_data_2[0]
    PU_data_in_2 = PU_N15_M01_F10_data_2[2]
    PU_data_out_2 = PU_N15_M01_F10_data_2[1]

    PU_N15_M01_F10_data_vibration = load_N15_M01_F10_data()
    print("PU_N15_M01_F10_data_vibration_length:", len(PU_N15_M01_F10_data_vibration))
    PU_data_n_vibration = PU_N15_M01_F10_data_vibration[0]
    PU_data_in_vibration = PU_N15_M01_F10_data_vibration[2]
    PU_data_out_vibration= PU_N15_M01_F10_data_vibration[1]

    PU_data_n, PU_data_n_vibration = filter(PU_data_n_2, PU_data_n_1, PU_data_n_vibration)
    PU_data_in,  PU_data_in_vibration = filter(PU_data_in_2, PU_data_in_1, PU_data_in_vibration)
    PU_data_out,  PU_data_out_vibration = filter(PU_data_out_2, PU_data_out_1, PU_data_out_vibration)
    '''
    2.处理原始轴承数据
    '''
    # 切割数据
    ...
    PU_data_n_vibration_cut = cut_data(PU_data_n_vibration, cut_number)
    PU_data_in_vibration_cut = cut_data(PU_data_in_vibration, cut_number)
    PU_data_out_vibration_cut = cut_data(PU_data_out_vibration, cut_number)
    ...
    # 0
    j = []
    for a, b in zip(PU_data_n_cut, PU_data_n_vibration_cut):
        j = [a, b]
        PU_data_n_cut_packge.append(j)
        j = []
    # 1
    j = []
    for a, b in zip(PU_data_in_cut, PU_data_in_vibration_cut):
        j = [a, b]
        PU_data_in_cut_packge.append(j)
        j = []
    # 2
    j = []
    for a, b in zip(PU_data_out_cut, PU_data_out_vibration_cut):
        j = [a, b]
    ...
    PU_data_out_vibration_label = [[0] for index in range(len(PU_data_n_vibration_cut))]
    PU_data_in_vibration_label = [[1] for index in range(len(PU_data_in_vibration_cut))]
    PU_data_n_vibration_label = [[2] for index in range(len(PU_data_out_vibration_cut))]
    ...
    Fault_label = []
    Fault_label = Fault_label + PU_data_out_label + PU_data_in_label + PU_data_n_label + PU_data_out_vibration_label + \
                  PU_data_in_vibration_label + PU_data_n_vibration_label
    Fault = []
