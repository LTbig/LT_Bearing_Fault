...
def filter(signal_1, signal_2):
    ...
    current2_filtered = waverec(signal_2)
        # np.fft.fftfreq(len(signal_1), signal_1[1]-signal_1[0])
...
if __name__ == '__main__':
    ...
    # 展示数据信息
    # print("=======================X======================")
    # print(N15_M07_F04_K001_1.data['N15_M07_F04_K001_1']['X'])
    # print("=======================Y======================")
    # print(N15_M07_F04_K001_1.data['N15_M07_F04_K001_1']['Y'][0][0][0])
    # 滤波和去噪
    s11, s12, s13, s14, s15, s16 = filter(signal_1=N15_M07_F04_K001_1.data['N15_M07_F04_K001_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F04_K001_1.data['N15_M07_F04_K001_1']['Y'][0][0][0][2][2][0])
    '''
    2.OuterFault
    '''
    # KA01
    ...
    # 滤波和去噪
    s21, s22, s23, s24, s25, s26 = filter(signal_1=N15_M07_F04_KA01_1.data['N15_M07_F04_KA01_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F04_KA01_1.data['N15_M07_F04_KA01_1']['Y'][0][0][0][2][2][0])
    '''
    3.InnerFault
    '''
    # KI01
    ...
    s31, s32, s33, s34, s35, s36 = filter(signal_1=N15_M07_F04_KI01_1.data['N15_M07_F04_KI01_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F04_KI01_1.data['N15_M07_F04_KI01_1']['Y'][0][0][0][2][2][0])
    ...
    s41, s42, s43, s44, s45, s46 = filter(signal_1=N15_M07_F04_KB27_1.data['N15_M07_F04_KB27_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F04_KB27_1.data['N15_M07_F04_KB27_1']['Y'][0][0][0][2][2][0])
    '''
    ...
    s51, s52, s53, s54, s55, s56 = filter(signal_1=N15_M07_F04_KB24_1.data['N15_M07_F04_KB24_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F04_KB24_1.data['N15_M07_F04_KB24_1']['Y'][0][0][0][2][2][0])
    # phase_current
    # plt.title("N15_M07_F04  phase_current")
    '''
     1.NORMAL
     '''
