...
dataloader = DataLoader(Train_dataset, shuffle=True, batch_size=2000, drop_last=True)
...
model = torch.load('models/N15_M07_F10/CAR_100.0.pth',  map_location=torch.device('cpu'))
...
# df.to_csv('N15_M07_F10_Tsne_data.csv', index=False)
...
# 设置颜色映射
colors = ['#FF0000', '#00FF00', '#0000FF', '#8A2BE2', '#D2691E']
