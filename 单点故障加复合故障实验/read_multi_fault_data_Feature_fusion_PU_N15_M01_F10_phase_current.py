...
def ready_data():
    ...
    PU_data_out_add, PU_data_out_diff, PU_data_out_multiplication, PU_data_out_seta = filter(PU_data_out_2,
                                                                                             PU_data_out_1)
    PU_data_inout_add, PU_data_inout_diff, PU_data_inout_multiplication, PU_data_inout_seta = filter(PU_data_inout_2,
                                                                                                     PU_data_inout_1)
    PU_data_outin_add, PU_data_outin_diff, PU_data_outin_multiplication, PU_data_outin_seta = filter(PU_data_outin_2,
                                                                                                     PU_data_outin_1)
    '''
    2.处理轴承数据
    '''
    ...
    # 3
    j = []
    for a, b, c, d in zip(PU_data_outin_add_cut, PU_data_outin_diff_cut, PU_data_outin_multiplication_cut, PU_data_outin_seta_cut):
        j = [a, b, c, d]
        PU_data_outin_cut_packge.append(j)
        j = []
    # 4
    j = []
    for a, b, c, d in zip(PU_data_inout_add_cut, PU_data_inout_diff_cut, PU_data_inout_multiplication_cut, PU_data_inout_seta_cut):
        j = [a, b, c, d]
    ...
    Fault_label = Fault_label + PU_data_out_add_label + PU_data_in_add_label + PU_data_outin_add_label + \
                  ...
                  PU_data_inout_seta_label + PU_data_n_seta_label
    Fault = []
