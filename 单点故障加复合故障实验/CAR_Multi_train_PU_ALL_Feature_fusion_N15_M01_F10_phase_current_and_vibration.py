...
from read_multi_fault_data_ALL_Feature_fusion_PU_N15_M01_F10_phase_current_and_vibration import ready_data
...
def Confusion_matrix_plt(confusion, epoch):
    ...
    # 每1轮的混淆矩阵的标题
    plt.title('Confusion matrix_{}_N15_M01_F10'.format(epoch))
...
def test():
    ...
    if test_acc == 100:
        torch.save(model, './models/N15_M01_F10_CAR_{}.pth'.format(test_acc))
