...
def ready_data():
    ...
    PU_data_n_1, PU_data_n_2 = filter(PU_data_n_1, PU_data_n_2)
    PU_data_in_1, PU_data_in_2 = filter(PU_data_in_1, PU_data_out_2)
    PU_data_out_1,  PU_data_out_2 = filter(PU_data_out_1, PU_data_in_2)
    PU_data_inout_1,  PU_data_inout_2 = filter(PU_data_inout_1, PU_data_inout_2)
    PU_data_outin_1,  PU_data_outin_2 = filter(PU_data_outin_1, PU_data_outin_2)
    '''
    2.处理轴承数据
    '''
    # 切割数据
    ...
    # 3
    j = []
    for a, b in zip(PU_data_inout_1_cut, PU_data_inout_2_cut):
        j = [a, b]
        PU_data_inout_cut_packge.append(j)
        j = []
    # 4
    j = []
    for a, b in zip(PU_data_outin_1_cut, PU_data_outin_2_cut):
        j = [a, b]
    ...
    Fault_label = []
    Fault_label = Fault_label + PU_data_out_1_label + PU_data_in_1_label + PU_data_outin_1_label + \
                  PU_data_inout_1_label + PU_data_n_1_label + PU_data_out_2_label + PU_data_in_2_label + PU_data_outin_2_label + \
                  PU_data_inout_2_label + PU_data_n_2_label
    Fault = []
