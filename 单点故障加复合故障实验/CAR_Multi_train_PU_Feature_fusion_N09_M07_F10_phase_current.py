...
from read_multi_fault_data_Feature_fusion_PU_N09_M07_F10_phase_current import ready_data
...
for i in range(len(data)):
    ...
    temp = data[i][1].reshape(40, 64)
    temp = data[i][2].reshape(40, 64)
    temp = data[i][3].reshape(40, 64)
    data[i][0] = temp
    data[i][1] = temp
    data[i][2] = temp
    data[i][3] = temp
