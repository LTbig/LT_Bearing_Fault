...
if __name__ == '__main__':
    ...
    # 滤波和去噪
    s11, s12, s13, s14, s15, s16, s17 = filter(signal_1=N15_M07_F10_K001_1.data['N15_M07_F10_K001_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F10_K001_1.data['N15_M07_F10_K001_1']['Y'][0][0][0][2][2][0],
                                          signal_3=N15_M07_F10_K001_1.data['N15_M07_F10_K001_1']['Y'][0][0][0][-1][2][0])
    '''
    2.OuterFault
    '''
    # KA01
    ...
    # 滤波和去噪
    s21, s22, s23, s24, s25, s26, s27 = filter(signal_1=N15_M07_F10_KA01_1.data['N15_M07_F10_KA01_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F10_KA01_1.data['N15_M07_F10_KA01_1']['Y'][0][0][0][2][2][0],
                                          signal_3=N15_M07_F10_KA01_1.data['N15_M07_F10_KA01_1']['Y'][0][0][0][-1][2][0])
    '''
    3.InnerFault
    '''
    # KI01
    ...
    s31, s32, s33, s34, s35, s36, s37 = filter(signal_1=N15_M07_F10_KI01_1.data['N15_M07_F10_KI01_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F10_KI01_1.data['N15_M07_F10_KI01_1']['Y'][0][0][0][2][2][0],
                                          signal_3=N15_M07_F10_KI01_1.data['N15_M07_F10_KI01_1']['Y'][0][0][0][-1][2][0])
    ...
    s41, s42, s43, s44, s45, s46, s47 = filter(signal_1=N15_M07_F10_KB27_1.data['N15_M07_F10_KB27_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F10_KB27_1.data['N15_M07_F10_KB27_1']['Y'][0][0][0][2][2][0],
                                          signal_3=N15_M07_F10_KB27_1.data['N15_M07_F10_KB27_1']['Y'][0][0][0][-1][2][0])
    '''
    ...
    s51, s52, s53, s54, s55, s56, s57 = filter(signal_1=N15_M07_F10_KB24_1.data['N15_M07_F10_KB24_1']['Y'][0][0][0][1][2][0],
               signal_2=N15_M07_F10_KB24_1.data['N15_M07_F10_KB24_1']['Y'][0][0][0][2][2][0],
                                          signal_3=N15_M07_F10_KB24_1.data['N15_M07_F10_KB24_1']['Y'][0][0][0][-1][2][0])
    # phase_current
    # plt.title("N15_M07_F10  phase_current")
    '''
     1.NORMAL
     '''
    ...
    # vibration
    plt.figure(figsize=(16, 9))
    plt.suptitle("Vibration")
    plt.subplots_adjust(hspace=0.3)

    plt.subplot(511)
    plt.title("NORMAL")
    plt.plot(s17, label="NORMAL Vibration")
    # s17_data = s17[0:2560]
    # for i in range(len(s17_data)):
    #     print(s17[i])
    # print("===s17====")
    plt.xlim(0, 2560)
    ...
    plt.subplot(512)
    plt.title("OR")
    plt.plot(s27, label="OuterFault Vibration")
    # s27_data = s27[0:2560]
    # for i in range(len(s27_data)):
    #     print(s27[i])
    # print("===s27====")
    plt.xlim(0, 2560)
    ...
    plt.subplot(513)
    plt.title("IR")
    plt.plot(s37, label="InnerFault Vibration")
    # s37_data = s37[0:2560]
    # for i in range(len(s37_data)):
    #     print(s37[i])
    # print("===s37====")
    plt.xlim(0, 2560)
    ...
    plt.subplot(514)
    plt.title("OR_IR")
    plt.plot(s47, label="OuterFault+InnerFault Vibration")
    # s47_data = s47[0:2560]
    # for i in range(len(s47_data)):
    #     print(s47[i])
    # print("===s47====")
    plt.xlim(0, 2560)
    ...
    plt.subplot(515)
    plt.title("IR_OR")
    plt.plot(s57, label="InnerFault+OuterFault Vibration")
    s57_data = s57[0:2560]
    for i in range(len(s57_data)):
        print(s57[i])
    print("===s57====")
    plt.xlim(0, 2560)
