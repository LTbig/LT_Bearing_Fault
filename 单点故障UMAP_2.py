...
model = torch.load('models/N15_M07_F04/CAR_99.88839285714286.pth',  map_location=torch.device('cpu'))
...
# print(output.shape)
# print(output)
# 使用UMAP算法将高维特征映射为二维特征向量
umap_model = umap.UMAP(n_components=2, random_state=42)
test_data_umap  = umap_model.fit_transform(output.detach().numpy())
data_umap = Min_Max_Scaling(test_data_umap)
# print(X_tsne.shape)
# print(X_tsne)
...
# 绘制散点图
plt.scatter(data_umap[:, 0], data_umap[:, 1], c=labels, cmap=cmap)
# 添加图例
