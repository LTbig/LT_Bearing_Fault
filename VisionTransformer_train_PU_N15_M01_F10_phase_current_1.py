...
from read_fault_data_PU_N15_M01_F10_phase_current_1 import ready_data
...
# train_dataset, test_dataset = random_split(dataset=data, lengths=[1600, 400])
...
writer = SummaryWriter('./Vlogs/150110')
